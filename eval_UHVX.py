...
def parse_args():
    ...
    parser.add_argument("--pretrain_weights", type=str, default='/root/home/data/ZSH/RA-HVED-main/results/U_HVEDConvDuSFEmViLNet3D/best_dice_ckpt.pth.tar', help="预训练权重保存路径")
